...
export const WelcomeScreen = ({ onPromptClick }: WelcomeScreenProps) => {
  return (
    <div className="flex flex-col items-center justify-start md:justify-center text-center px-3 pt-6 pb-4 md:p-4 md:py-12 h-full">
      <motion.div
      ...
      >
        ...
        <div className="mx-auto mb-2 md:mb-3 h-10 w-10 md:h-16 md:w-16 flex items-center justify-center rounded-full bg-primary/10 text-primary">
